...
<body>
	<div class="htmleaf-container">
		...
		<div class="htmleaf-content">
            ...
            <form action="/upload/medicine" method="post" enctype="multipart/form-data">
                <table>
                <tr><td>
                    <label>选择上传文件类型：</label>
                </td></tr>
                <tr><td>
                    <label><input type="radio" name="type" value="clinic" /> 门诊数据（有字段头）： </label></td>
                    <td><label>包含字段：日期,星期,科室名称,医生,时段,初诊,复诊 </label></td>
                    <tr><td></td><td>
                    <label>例如：4/1/2017,星期六,某某科,某某,上午,2,0 </label></td>
                </tr>
                <tr><td>
                    <label><input type="radio" name="type" value="emergency" /> 急诊数据（有字段头）： </label></td>
                ...
                <tr><td>
                    <label><input type="radio" name="type" value="transfer" /> 院医转科室数据（有字段头）： </label></td>
                    <td><label>包含字段：科室,姓名,出诊时间 </label></td>
                    <tr><td></td><td>
                    <label>例如：某某科,某某,周一上午、周三全天、周四下午 </label></td></tr>
                    <tr><td></td><td>
                ...
                <tr><td>
                    <label><input type="radio" name="type" value="ward" /> 病房数据（有字段头）： </label></td>
                    <td><label>包含字段：科室,姓名,出诊时间 </label></td>
                    <tr><td></td><td>
                    <label>例如：某某科,某某,周一上午、周三全天、周四下午 </label></td></tr>
                    <tr><td></td><td>
